              ...
              <form className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    required
                    autoComplete="off"
                    className=" border-2 border-black mt-1 w-full rounded-md  bg-white text-sm text-gray-700 shadow-sm"
                  />
                </div>
                ...
                <div className="col-span-6">
                  <label htmlFor="MarketingAccept" className="flex gap-4">
                    <input
                      ...
                      className="size-5 rounded-md border-blue-900 bg-white shadow-sm"
                    />
...
{/* 
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  ...
                  <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                    Not have an account?
                    <NavLink to="/register" className=  " ml-2 font-extrabold text-gray-700 underline">Regsiter Now</NavLink>.
                  </p>
                </div>
              </form>
            </div>

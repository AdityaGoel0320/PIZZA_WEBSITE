        ...
        <form method='POST' className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            <label htmlFor="MarketingAccept" className="flex gap-4">
              <input
                ...
                className="size-5 rounded-md border-2 border-blue-900 bg-white shadow-sm"
              />
          ...
          <div className="col-span-6">
            <p className="text-sm text-black">
              ...
              <NavLink to="/TandC"  target='_blank' className="text-gray-700 underline"> terms and conditions </NavLink>
              and
              <NavLink to="/privacyPolicies"  target='_blank' className="text-gray-700 underline">privacy policy</NavLink>.
            </p>
          </div>
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:mt-0">
              ...
              <NavLink to="/login" className=" ml-2 text-black font-extrabold underline">Log in</NavLink>.
            </p>
          </div>
        </form>
      </div>
